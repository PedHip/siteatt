...
<body>
    ...
    <div class="container">
        ...
        <div class="card-container" id="acrilicoProductsContainer">
    ...
    <script>
        $(document).ready(function() {
            function listarProdutosAcrilico() {
                $.ajax({
                    url: 'listar_produtos.php',
                    type: 'GET',
                    data: { term: 'bubble_acrilico' },
                    dataType: 'json',
            ...
            listarProdutosAcrilico();

            function atualizarCards(produtos) {
                const container = $("#acrilicoProductsContainer");
                container.empty();
