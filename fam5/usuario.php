...
class Usuario {
    ...
    public function cadastrar() {
        ...
        if ($stmt->execute()) {
            return json_encode(['status' => 'success', 'message' => '<div style="color:green;">Cadastro realizado com sucesso!</div>']);
        } else {
            return json_encode(['status' => 'error', 'message' => '<div style="color:red;">Erro ao realizar o cadastro.</div>']);
        }
    }
